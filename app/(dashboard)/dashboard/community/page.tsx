...
function RoleBadge({ role }: { role: JoinedCommunity["role"] }) {
  const config = {
    ADMIN: {
      ...
      icon: Crown,
      color: "#fff",
      bg: "rgba(220,20,60,0.75)",
    },
    MODERATOR: {
      label: "Moderator",
      icon: Shield,
      color: "#fff",
      bg: "rgba(123,47,190,0.75)",
    },
    MEMBER: {
      label: "Member",
      icon: User,
      ...
      >
        ...
        <div className="flex gap-3">
          <button
            onClick={onCancel}
            disabled={loading}
            className="flex-1 py-2.5 rounded-xl text-sm font-bold transition-all hover:scale-[1.01] disabled:opacity-50"
            style={{
          ...
          <button
            onClick={onConfirm}
            disabled={loading}
            className="flex-1 py-2.5 rounded-xl text-sm font-bold text-white transition-all hover:scale-[1.01] disabled:opacity-50 flex items-center justify-center gap-2"
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-3 left-3 right-3 flex items-center justify-between z-10">
        <span
          className="px-2 py-0.5 rounded-full text-[11px] font-semibold text-white backdrop-blur-sm"
    ...
    >
      ...
      <div>
        ...
        <p className="text-sm max-w-md" style={{ color: "var(--text-muted)" }}>
          Explore existing communities or create your own and start building
          together.
        </p>
      </div>
      <div className="flex items-center gap-3">
        <Link
          href="/community"
          className="flex items-center gap-2 px-5 py-2.5 rounded-xl text-sm font-bold transition-all hover:scale-[1.01]"
          style={{
            background: "var(--glass-bg)",
            border: "1px solid var(--glass-border)",
        ...
        <button
          onClick={onCreate}
          className="flex items-center gap-2 px-5 py-2.5 rounded-xl text-sm font-bold text-white transition-all hover:scale-[1.01]"
          style={{
            background:
              "linear-gradient(135deg, var(--scarlet), var(--purple))",
...
function SkeletonCard() {
  return (
    <div
      ...
      style={{ aspectRatio: "4/3", background: "var(--glass-bg-subtle)" }}
    />
  );
}
...
export default function DashboardCommunityPage() {
  ...
  const [confirmDelete, setConfirmDelete] = useState<JoinedCommunity | null>(
    null,
  );
            ...
            {view === "list" ? (
              <>
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm font-bold text-white transition-all hover:scale-[1.01]"
                  style={{
                    background:
                      "linear-gradient(135deg, var(--scarlet), var(--purple))",
                    boxShadow: "0 4px 14px rgba(220,20,60,0.3)",
          ...
          {view === "create" ? (
            ...
            >
              <form
                ...
                className="glass rounded-2xl p-6 flex flex-col gap-5 max-w-2xl"
              >
                <label className="cursor-pointer">
                  <div
                    className="w-full h-40 rounded-xl flex items-center justify-center overflow-hidden"
                    style={{
                ...
                <div className="flex gap-3">
                  <button
                    type="button"
                    onClick={() => setView("list")}
                    className="px-6 py-3 rounded-xl text-sm font-bold transition-all hover:scale-[1.01]"
                    style={{
                      background: "var(--glass-bg)",
                      border: "1px solid var(--glass-border)",
                      color: "var(--text-secondary)",
                  ...
                  <button
                    ...
                    className="flex-1 py-3 rounded-xl text-sm font-bold text-white flex items-center justify-center gap-2 transition-all hover:scale-[1.01] disabled:opacity-50"
                    style={{
                      background:
                        "linear-gradient(135deg, var(--scarlet), var(--purple))",
                      boxShadow: "0 4px 14px rgba(220,20,60,0.3)",
