...
import DeleteCourseCategoryButton from "./_components/DeleteCourseCategoryButton";

export default async function CourseCategoriesPage() {
  const [categories, totalCourses, categoriesWithCourses] = await Promise.all([
          ...
          <div className="flex items-center gap-4 mb-3">
            ...
            <div>
              ...
              <p className="text-[var(--text-muted)] mt-1">
                Manage categories used for your course library.
              </p>
            </div>
          </div>
        </div>
