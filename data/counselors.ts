...
export const counselors: Counselor[] = [
  ...
  },
  {
    ...
    reviews: 143,
    price: 2500,
    img: "/images/blessing.jpeg",
    available: true,
    verified: true,
    languages: ["English"],
    sessions: ["Text"],
    bio: "Expert travel consultant and business coach specializing in seamless international logistics. Kiki helps entrepreneurs and travelers navigate the complexities of trip planning, booking, and travel management with precision and ease.",
    country: "Cameroon",
  },
  {
    id: "jean-paul-mvondo",
