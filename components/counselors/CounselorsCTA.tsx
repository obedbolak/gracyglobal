...
export default function CounselorsCTA() {
  return (
    <section className="py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        <motion.div
          ...
          style={{
            background:
              "linear-gradient(135deg, var(--purple) 0%, var(--blue) 60%, var(--purple-light) 100%)",
            boxShadow:
        ...
        >
          ...
          <div className="relative z-10">
            <h2 className="text-3xl sm:text-4xl font-extrabold text-white mb-4 tracking-tight">
              What Broke You Doesn't
              <br />
              Get to Define You.
            </h2>
            <p className="text-white/65 text-base font-light max-w-xl mx-auto mb-10 leading-relaxed">
              Take the first step today. Your first session is a safe space — no
              judgment, no pressure, just progress.
            </p>
