    ...
    <section className="py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        <motion.div
          ...
          style={{
            background:
              "linear-gradient(135deg, var(--purple) 0%, var(--blue) 50%, var(--scarlet) 100%)",
            boxShadow:
              "0 24px 80px rgba(123,47,190,0.45), 0 4px 24px rgba(0,0,0,0.2)",
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-white/65 text-base font-light max-w-xl mx-auto mb-3 leading-relaxed">
              Join GracyGlobal affiliates already earning by referring
              counsellors, teachers, sellers, and service providers. Sign up in
              2 minutes, get your link, and start sharing today.
            </p>
            <p className="text-white/45 text-sm mb-10">
              20% commission on every payment — including recurring
              subscriptions.
            </p>
            <div className="flex flex-wrap items-center justify-center gap-4">
              {/* Takes them to dashboard where they click "Join Affiliate Program" */}
              <Link
